...
namespace HurricaneVR.Editor
{
    public class HVRGunCreator : EditorWindow
    {
        ...
        private HVRGrabbable SetupStabilizer(HVRGunBase hvrGunBase, Transform parent, HVRGrabbable gunGrabbable)
        {
            ...
            rbOverrides.InertiaTensorRotation = Vector3.zero;
            rbOverrides.InertiaTensor = new Vector3(.01f, .01f, .01f);

            var joint = offhand.AddComponent<FixedJoint>();

            joint.connectedBody = gunRB;
        ...
        private void SetupCommonObjects(HVRGunBase gun, GameObject model, HVRGrabbable gunGrabbable)
        {
            ...
            AddAmmoSocket(adjustTransforms, gun, model);
        ...
        internal GameObject AddAmmoSocket(GameObject parent, HVRGunBase gun, GameObject model)
        {
